  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert("Contents", [
      ...
      },
      {
        ...
        text:
          "Tirana's museums and monuments are among its most highly esteemed attractions. The National Historical " +
      ...
      },
      {
        ...
        text:
          "Tourism in Tirana is developing year by year and the capital city of Tirana become a very popular " +
      ...
      },
      {
        ...
        text:
          "Festivals are one of several things that locals enjoy well. The diversity of festivals makes it " +
      ...
      },
      {
        ...
        text:
          "Tirana has a diverse and vibrant nightlife. Among the youth, the most popular destination is the Blloku " +
